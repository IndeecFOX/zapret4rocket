...
777. Активировать zeefeer premium (Нажимать только Valery ProD, avg97, Xoz, Andrei_5288515371, Dina_turat, Александру, АлександруП, vecheromholodno, ЕвгениюГ, Dyadyabo, skuwakin, izzzgoy, subzeero452, Grigaraz, Reconnaissance, comandante1928, rudnev2028 и остальным поддержавшим проект. Но если очень хочется - можно нажать и другим)\033[0m'
 ...
 case "$answer_menu" in
  ...
  "13")
   ...
   ;;
  "777")
   echo -e "${green}Специальный zeefeer premium для Valery ProD, avg97, Xoz, Andrei_5288515371, Dina_turat, Александра, АлександраП, vecheromholodno, ЕвгенияГ, Dyadyabo, skuwakin, izzzgoy, Grigaraz, Reconnaissance, comandante1928, rudnev2028 и subzeero452 активирован. Наверное. Так же благодарю поддержавших проект VssA, vladdrazz, Alexey_Tob, Bor1sBr1tva, Azamatstd, iMLT, SasayKudasay1, alexander_novikoff, MarsKVV, porfenon123, bobrishe_dazzle, DA00001, geodomin, I_ZNA_I и анонимов${plain}"
   exit_to_menu
   ;;
  esac
 }
