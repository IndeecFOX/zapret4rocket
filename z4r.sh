...
777. Активировать zeefeer premium (Нажимать только Valery ProD, Xoz, Andrei_5288515371, Dina_turat, Александру, АлександруП, vecheromholodno, Евгению Головащенко, Dyadyabo, skuwakin, izzzgoy, subzeero452, Grigaraz и остальным поддержавшим проект. Но если очень хочется - можно нажать и другим)\033[0m'
 read -re -p '' answer
 case "$answer" in
  "0")
   echo "Выход выполнен"
  ...
  "13")
   ...
   ;;
  "777")
   echo -e "${green}Специальный zeefeer premium для Valery ProD, Xoz, Andrei_5288515371, Dina_turat, Александра, АлександраП, vecheromholodno, Евгения Головащенко, Dyadyabo, skuwakin, izzzgoy, Grigaraz и subzeero452 активирован. Наверное. Так же благодарю поддержавших проект comandante1928, VssA, vladdrazz, Alexey_Tob, Bor1sBr1tva, porfenon123, DA00001, geodomin и анонимов${plain}"
   exit_to_menu
   ;;
  esac
 }
