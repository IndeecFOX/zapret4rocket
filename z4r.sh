...
EOF
 ...
 echo -e "${green}Выполнение установки завешено. Доступ по ip вашего роутера/VPS в формате ip:17681, например 192.168.1.1:17681 или mydomain.com:17681 логин: ${ttyd_login} пароль - не испольузется.${plain}. Был выполнен выход из скрипта для сохранения состояния."
}
