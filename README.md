...
Дата        | Изменения
------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
30.12.25    | mod: таймаут проверки доступности ресурсов по TLS снижен с 2 до 1 секунды. Т.е. тест, особенно в новой реальности не отображает фактической ситуации, но задержка может мешать перебирать стратегии давая суммарно по 4 секунды на 1 проверку.
