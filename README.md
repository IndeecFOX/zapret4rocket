...
07.10.25    |- Ускорение обновления (меню 5) и развёртвывания на чистую
.           |- Снижение шанса зависнуть на wget (Теперь fake файлы качаются одним архивом. Это куда быстрее и меньше шанса зависнуть на wget. Автолист создаётся чистым, а не скачивается с той же целью)
