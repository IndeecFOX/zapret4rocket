...
Дата        | Изменения
------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
10.12.25v2  | Теперь проверяется действующий для вашего провайдера домен googlevideo.com, а не жёсткоустановленный, это поможет точнее определять доступность видео на YouTube. Но никто не отменял блок 16кб или тормоза. Так что ручная перепроверка необходима. code supporter: @zzzytaF
