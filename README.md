...
Дата        | Изменения
------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
3.01.25     | fix: для основного листа RKN в дефолте установлена 2 стратегия. Был баг - в дефолте не было стратегии
02.01.25    | fix: из безразборного режима убран googlevideo.com (Важно после вчерашего апдейта).
.           | mod: стратегия RKN заменена на 2 по дефолту. Универсальнее. Чинит ДС обычно.
02.01.25    | new: теперь в меню выбора альтернативных стратегий стратегия для видео на YouTube по TCP подбирается отдельно от самого ресурса. by AloofLibra
