...
28.12.25v2  | upd: 6 стратегия как дефолтная для ютуба. Дефолтная ютуба закомментирована
28.12.25    | upd: массовое обновление стратегий. Дефолтные и № 2, 5, 7, 11-17
27.12.25v2  | add: пеперь в подборе стратегии можно выбрать номер страты к которой сразу перейти
