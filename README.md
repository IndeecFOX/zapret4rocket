...
Дата        | Изменения
------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
11.11.25    | 1) new: Теперь в меню выводится статус zapret в цвете (Запущен/Остановлен)
.           | 2) new: При установке web-меню так же в лог выводится проверка запущена ли служба и прослушивается ли порт.
